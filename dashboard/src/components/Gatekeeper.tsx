...
const Gatekeeper = ({ onComplete }: GatekeeperProps) => {
    ...
    const updateStatus = (id: number, status: 'pending' | 'loading' | 'success') => {
                                    ...
                                    <div className="profiler-form">
                                            ...
                                            <div className="role-toggles" role="radiogroup" aria-labelledby={`role-${step.id}`}>
                                                {['Frontend', 'Backend', 'DevOps', 'SysOps'].map(role => (
                                                    <button
                                                        ...
                                                        onClick={() => step.value && handleInputChange(step.id, { ...step.value, role })}
                                                        role="radio"
                                        ...
                                        <div className="profiler-group">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => step.value && handleInputChange(step.id, { ...step.value, stack: e.target.value })}
                                        ...
                                        <div className="profiler-group">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => step.value && handleInputChange(step.id, { ...step.value, design: Number(e.target.value) })}
                                        ...
                                        <div className="profiler-group">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => step.value && handleInputChange(step.id, { ...step.value, efficiency: Number(e.target.value) })}
                                        ...
                                        <div className="profiler-group">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => step.value && handleInputChange(step.id, { ...step.value, debugging: Number(e.target.value) })}
                                        ...
                                        <div className="profiler-group">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => step.value && handleInputChange(step.id, { ...step.value, objective: e.target.value })}
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                if (step.value && step.value.role && step.value.stack && step.value.objective) {
                                                    updateStatus(step.id, 'loading');
                                                    mockValidate(() => updateStatus(step.id, 'success'));
                                                }
                                            }}
                                            disabled={!(step.value && step.value.role && step.value.stack && step.value.objective)}
